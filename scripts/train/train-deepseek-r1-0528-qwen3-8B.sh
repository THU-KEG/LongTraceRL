...
# exp
EXP_TAG=train-deepseek-r1-0528-qwen3-8B
REF_MODEL_PATH=$PROJECT_ROOT/models/torch_dist_models/DeepSeek-R1-0528-Qwen3-8B
HF_MODEL_PATH=$PROJECT_ROOT/models/hf_models/DeepSeek-R1-0528-Qwen3-8B
CKPT_DIR=$PROJECT_ROOT/outputs/${EXP_TAG}

# DeepSeek-R1-0528-Qwen3-8B (Qwen3 architecture, 36 layers, rope_theta=1000000)
MODEL_ARGS=(
...
ROLLOUT_ARGS=(
    ...
    --label-key label
    --source-config-path configs/source_config_deepseek_r1_distill_rubric.json
    ...
    --rollout-stop-token-ids 151645  # <｜end▁of▁sentence｜>
...
ray job submit --address="http://127.0.0.1:8265" \
    ...
    --sglang-json-model-override-args "{\"max_position_embeddings\": $((MAX_CONTEXT_LEN + 1000))}" \
