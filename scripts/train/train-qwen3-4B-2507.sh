...
# exp
EXP_TAG=train-qwen3-4B-2507
REF_MODEL_PATH=$PROJECT_ROOT/models/torch_dist_models/Qwen3-4B-Thinking-2507
HF_MODEL_PATH=$PROJECT_ROOT/models/hf_models/Qwen3-4B-Thinking-2507
