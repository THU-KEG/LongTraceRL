...
# exp
EXP_TAG=train-qwen3-30B-A3B-2507
REF_MODEL_PATH=$PROJECT_ROOT/models/torch_dist_models/Qwen3-30B-A3B-Thinking-2507
HF_MODEL_PATH=$PROJECT_ROOT/models/hf_models/Qwen3-30B-A3B-Thinking-2507
