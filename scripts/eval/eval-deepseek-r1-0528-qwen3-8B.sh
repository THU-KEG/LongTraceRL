...
# exp
EXP_TAG=eval-deepseek-r1-0528-qwen3-8B
REF_MODEL_PATH=$PROJECT_ROOT/models/torch_dist_models/LongTraceRL-8B
HF_MODEL_PATH=$PROJECT_ROOT/models/hf_models/LongTraceRL-8B
CKPT_DIR=$PROJECT_ROOT/outputs/${EXP_TAG}

# DeepSeek-R1-0528-Qwen3-8B (Qwen3 architecture)
MODEL_ARGS=(
